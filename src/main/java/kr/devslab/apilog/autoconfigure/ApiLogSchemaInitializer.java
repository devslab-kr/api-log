 ...
 */
public class ApiLogSchemaInitializer extends DataSourceScriptDatabaseInitializer {

    /** Classpath path of the bundled schema script (shared with {@link ApiLogFlywayConfig}). */
    public static final String SCHEMA_SCRIPT = "classpath:db/api-log/V1.0__create_api_log.sql";

    public ApiLogSchemaInitializer(DataSource dataSource) {
